...
# 环境变量
UUID = os.environ.get('UUID', '56ad3f61-7555-4774-aeb1-5d8ec4b7b319')   # 节点UUID
...
DOMAIN = os.environ.get('DOMAIN', 'maohipy-6d8a.onbelmo.uk')                # 项目分配的域名或反代后的域名,不包含https://前缀,例如: domain.xxx.com
